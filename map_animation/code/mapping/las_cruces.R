...
# The raster
elev_raster <- raster::raster(paste0(dsn, "/", "ASTGTM2_N32W107_dem-Las_Cruces.tif"))
...
# Wide
frame_extent@xmax <- -106.42
frame_extent@xmin <- -106.63
frame_extent@ymax <- 32.7
frame_extent@ymin <- 32.15
...
for (filetype in filetypes) {
  for (map in names(maps)) {
    ...
    ggsave(filename = filename,
           path = "C:/Users/Nelson/Documents/Projects/Other/topo_commissions/outputs/las_cruces",
           plot = maps[[map]],
           device = filetype,
           width = width,
           height = height)
    # And this converts the SVG to a PNG because sometimes you need that too
    system(command = paste0("magick convert -density 300 C:\\Users\\Nelson\\Documents\\Projects\\Other\\topo_commissions\\outputs\\las_cruces\\", filename,
                            " C:\\Users\\Nelson\\Documents\\Projects\\Other\\topo_commissions\\outputs\\las_cruces\\", gsub(filename, pattern = "svg$", replacement = "png")))
    # And this converts the SVG to a PNG because sometimes you need that too
    system(command = paste0("magick convert -density 300 C:\\Users\\Nelson\\Documents\\Projects\\Other\\topo_commissions\\outputs\\las_cruces\\", filename,
                            " C:\\Users\\Nelson\\Documents\\Projects\\Other\\topo_commissions\\outputs\\las_cruces\\", gsub(filename, pattern = "svg$", replacement = "tif")))
  }
}
...
for (variant in 1:nrow(variants_df)) {
  ggsave(filename = paste0("las_cruces_tight",
         ...
         path = "C:/Users/Nelson/Documents/Projects/Other/topo_commissions/outputs/las_cruces/testing",
